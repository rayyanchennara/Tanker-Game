...
namespace MatthewAssets
{
    ...
    {
        public ParticleSystem particle; // Asigna el sistema de partículas en el Inspector
        ...
        {
            SetRandomRotation();
            particle.Play(); // Inicia el sistema de partículas (opcional)
        }
        ...
        void SetRandomRotation()
        {
            ...
            particle.transform.rotation = Quaternion.Euler(0f, 0f, randomZRotation);
        }
    }
}